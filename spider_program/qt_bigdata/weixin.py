...
参考文献：http://blog.csdn.net/d1240673769/article/details/75907152
google driver: https://sites.google.com/a/chromium.org/chromedriver/downloads
step1 #登录微信公众号，获取登录之后的cookies信息，并保存到本地文本中
不能模拟登陆，只能用cookie 模拟登陆的效果

"""

import requests
import bs4, os,re ,json ,time
import pandas as pd
import time
import numpy as np
...
if __name__=='__main__':
    try:
        print("登录微信公众号，获取登录之后的cookies信息，并保存到本地文本中")
        # weChat_login()
